...
--------------------------------------------------------------*/
	...
	if (is_plugin_active('wordpress-seo-premium/wp-seo-premium.php')) {
		...
		$wpSEOSettings['noindex-tax-jobsite_geo-service-types']     = '1';
		$wpSEOSettings['display-metabox-tax-jobsite_geo-service-types'] = '0';
		$wpSEOSettings['noindex-tax-jobsite_geo-service-areas']     = '1';
		$wpSEOSettings['display-metabox-tax-jobsite_geo-service-areas'] = '0';
