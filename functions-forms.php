...
function battleplan_setupFormEmail( $contact_form, &$abort, $submission ) { 
	...
	foreach($bad_words as $bad_word) :
		if (stripos($full_email, $bad_word) !== false) $spamIntercept .= ' Words;';
	endforeach;
