...
$printPage = '
	...
	<p>Terms & Conditions are effective as of September 29, 2021.</p>';
...
$printPage .= '	
	...
	<p class="indent">a) Company, Us, We: The Company, as the creator, operator, and publisher of the Website, makes the Website, and certain Services on it, available to users. [get-biz info="name"], Company, Us, We, Our, Ours and other first-person pronouns will refer to the Company, as well as all employees and affiliates of the Company.</p>
	
	<p class="indent">b) You, the User, the Client: You, as the user of the Website, will be referred to throughout this Agreement with second-person pronouns such as You, Your, Yours, or as User or Client.</p>
	
	<p class="indent">c) Parties: Collectively, the parties to this Agreement (the Company and You) will be referred to as Parties.</p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') ASSENT &amp; ACCEPTANCE</strong></p>
	
	<p>By using the Website, You warrant that You have read and reviewed this Agreement and that You agree to be bound by it. If You do not agree to be bound by this Agreement, please leave the Website immediately. The Company only agrees to provide use of this Website and Services to You if You assent to this Agreement.</p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') LICENSE TO USE WEBSITE</strong></p>
...
$printPage .= '	
	...
	<p class="indent">a) In order to make the Website and Services available to You, You hereby grant the Company a royalty-free, non-exclusive, worldwide license to copy, display, use, broadcast, transmit and make derivative works of any content You publish, upload, or otherwise make available to the Website ("Your Content"). The Company claims no further proprietary rights in Your Content.</p>
	
	<p class="indent">b) If You feel that any of Your intellectual property rights have been infringed or otherwise violated by the posting of information or media by another of Our users, please contact Us and let Us know.</p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') USER OBLIGATIONS</strong></p>
...
$printPage .= '	
	...
	<p class="indent">a) You further agree not to use the Website or Services:</p>
	
	<p class="indent-double">I) To harass, abuse, or threaten others or otherwise violate any person\'s legal rights;</p>
	
	<p class="indent-double">II) To violate any intellectual property rights of the Company or any third party;</p>
	
	<p class="indent-double">III) To upload or otherwise disseminate any computer viruses or other software that may damage the property of another;</p>
	
	<p class="indent-double">IV) To perpetrate any fraud;</p>
	
	<p class="indent-double">V) To engage in or create any unlawful gambling, sweepstakes, or pyramid scheme;</p>
	
	<p class="indent-double">VI) To publish or distribute any obscene or defamatory material;</p>
	
	<p class="indent-double">VII) To publish or distribute any material that incites violence, hate, or discrimination towards any group;</p>
	
	<p class="indent-double">VIII) To unlawfully gather information about others.</p>';
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') PRIVACY INFORMATION</strong></p>
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') THIRD-PARTY LINKS &amp; CONTENT</strong></p>
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') MODIFICATION &amp; VARIATION</strong></p>
	...
	<p class="indent">a) To the extent any part or sub-part of this Agreement is held ineffective or invalid by any court of law, You agree that the prior, effective version of this Agreement shall be considered enforceable and valid to the fullest extent.</p>
	...
	<p class="indent">c) In the event that You fail to monitor any modifications to or variations of this Agreement, You agree that such failure shall be considered an affirmative waiver of Your right to review the modified Agreement.</p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') ENTIRE AGREEMENT</strong></p>
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') SERVICE INTERRUPTIONS</strong></p>
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') TERM, TERMINATION &amp; SUSPENSION</strong></p>
...
$num++;
$printPage .= '	
	<p><strong>'.$num.') LIMITATION ON LIABILITY</strong></p>

	<p>The Company is not liable for any damages that may occur to You as a result of Your use of the Website or Services, to the fullest extent permitted by law. We do not accept any liability of any kind.</span></p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') GENERAL PROVISIONS</strong></p>
	
	<p class="indent"><strong>a) LANGUAGE:</strong> All communications made or notices given pursuant to this Agreement shall be in the English language.</p>
	
	<p class="indent"><strong>b) JURISDICTION, VENUE &amp; CHOICE OF LAW:</strong> Through Your use of the Website or Services, You agree that the laws of the State of [get-biz info="state-full"] shall govern any matter or dispute relating to or arising out of this Agreement, as well as any dispute of any kind that may arise between You and the Company, with the exception of its conflict of law provisions. The Parties agree that this choice of law, venue, and jurisdiction provision is not permissive, but rather mandatory in nature. You hereby waive the right to any objection of venue, including assertion of the doctrine of forum non conveniens or similar doctrine.</p>
	
	<p class="indent"><strong>c) ARBITRATION:</strong> In case of a dispute between the Parties relating to or arising out of this Agreement, the Parties shall first attempt to resolve the dispute personally and in good faith. If these personal resolution attempts fail, the Parties shall then submit the dispute to binding arbitration. The arbitration shall be conducted by a single arbitrator, and such arbitrator shall have no authority to add Parties, vary the provisions of this Agreement, award punitive damages, or certify a class. The arbitrator shall be bound by applicable and governing Federal law as well as the law of [get-biz info="state-full"]. Each Party shall pay their own costs and fees. Claims necessitating arbitration under this section include, but are not limited to: contract claims, tort claims, claims based on Federal and state law, and claims based on local laws, ordinances, statutes or regulations. <em>Intellectual property claims by the Company will not be subject to arbitration and may, as an exception to this sub-part, be litigated. </em>The Parties, in agreement with this sub-part of this Agreement, waive any rights they may have to a jury trial in regard to arbitral claims.</p>
	
	<p class="indent"><strong>d) SEVERABILITY:</strong> If any part or sub-part of this Agreement is held invalid or unenforceable by a court of law or competent arbitrator, the remaining parts and sub-parts will be enforced to the maximum extent possible. In such condition, the remainder of this Agreement shall continue in full force.</p>
	
	<p class="indent"><strong>e) NO WAIVER:</strong> In the event that We fail to enforce any provision of this Agreement, this shall not constitute a waiver of any future enforcement of that provision or of any other provision. Waiver of any part or sub-part of this Agreement will not constitute a waiver of any other part or sub-part.</p>
	
	<p class="indent"><strong>f) HEADINGS FOR CONVENIENCE ONLY:</strong> Headings of parts and sub-parts under this Agreement are for convenience and organization, only. Headings shall not affect the meaning of any provisions of this Agreement.</p>
	
	<p class="indent"><strong>g) NO AGENCY, PARTNERSHIP OR JOINT VENTURE:</strong> No agency, partnership, or joint venture has been created between the Parties as a result of this Agreement. No Party has any authority to bind the other to third parties.</p>';
	
$num++;
$printPage .= '	
	<p><strong>'.$num.') CHANGES TO THESE TERMS AND CONDITIONS</strong></p>

	<p>You acknowledge and agree that it is your responsibility to review this Site and these Terms &amp; Conditions periodically and to be aware of any modifications. We will notify you of any changes to these Terms &amp; Conditions by posting those changes on this page.</p>';
