						...
						$displayFooter .= '<nav class="navigation single" role="navigation" aria-label="Posts">';
							...
							$displayFooter .= '<div class="nav-links">';
								...
								if ( $prev_post ) :
									...
									$displayFooter .= '<a class="nav-previous prev" href="'.get_permalink( $prev_post->ID ).'" rel="prev"><div class="post-arrow">[get-icon type="chevron-left" top="7"]</div><div class="post-links"><div class="meta-nav">Previous</div><div class="post-title">'.$prev_title.'</div></div></a>';
								else:
								...
								if ( $next_post ) :
									...
									$displayFooter .= '<a class="nav-next next" href="'.get_permalink( $next_post->ID ).'" rel="next"><div class="post-links"><div class="meta-nav">Next</div><div class="post-title">'.$next_title.'</div></div><div class="post-arrow">[get-icon type="chevron-right" top="7"]</span></div></a>';
								else:
