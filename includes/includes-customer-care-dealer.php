...
$printPage = '
	...
	<img class="alignright size-quarter-s noFX customer-care-logo" src="/wp-content/themes/battleplantheme/common/hvac-american-standard/customer-care-dealer-logo.png" alt="American Standard Customer Care Dealer" />
	...
	<img class="alignright noFX size-third-s" src="/wp-content/themes/battleplantheme/common/hvac-american-standard/customer-care-dealer-products.png" alt="American Standard Heating and Cooling Products" />
...
if ( $type == "teaser" ) :
	return do_shortcode('
		 [txt size="100"]
		  ...
		  <a href="/customer-care-dealer/" aria-hidden="true" tabindex="-1"><img src="/wp-content/themes/battleplantheme/common/hvac-american-standard/customer-care-dealer-logo.png" alt="We are an American Standard Customer Care Dealer." class="alignright size-quarter-s noFX customer-care-logo" /></a>
