document.addEventListener("DOMContentLoaded", function () {	"use strict"; (function($) {
	...
	// Set up woocommerce pages to match rest of site
		$('.woocommerce-js main#main').unwrap();
		$('.woocommerce-js main#main').attr('id', 'primary');		
		
	// Set up products in CSS grid		
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-2').addClass('grid-2e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-3').addClass('grid-3e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-4').addClass('grid-4e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-5').addClass('grid-5e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-6').addClass('grid-6e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-7').addClass('grid-7e');
		$('.theme-battleplantheme.woocommerce-js ul.products.columns-8').addClass('grid-8e');
