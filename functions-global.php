...
if ( !defined('_BP_VERSION') ) define( '_BP_VERSION', '23.7' );
...
if ( !is_admin() && !defined('_GOOGLE_AD_LOCATION') ) :
	...
	define( '_GOOGLE_AD_LOCATION', $location );
endif;

if ( !defined('_GOOGLE_AD_LOCATION') ) define( '_GOOGLE_AD_LOCATION', 'none' );
