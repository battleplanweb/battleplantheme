<?php
/* Battle Plan Web Design - Why Choose Ruud */

return do_shortcode('
	[section name="Why Choose Ruud" class="why-choose-us" style="'.$style.'" width="'.$width.'"]
		[layout grid="1-1-1-1" valign="stretch"] 
			[col class="span-all"]
				[txt]
					<img src="'.$img.'" loading="lazy" alt="'.$alt.'" class="noFX" width="480" height="302" style="aspect-ratio:480/302" />
				[/txt]
			[/col]
