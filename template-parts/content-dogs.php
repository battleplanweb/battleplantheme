...
$a1 = esc_attr(get_field ( "sire" ));
$a2 = esc_attr(get_field( "dam" ));
$b1 = esc_attr(get_field( "grandparent_1" ));
$b2 = esc_attr(get_field( "grandparent_2" ));
$b3 = esc_attr(get_field( "grandparent_3" ));
$b4 = esc_attr(get_field( "grandparent_4" ));
$c1 = esc_attr(get_field( "great_grandparent_1" ));
$c2 = esc_attr(get_field( "great_grandparent_2" ));
$c3 = esc_attr(get_field( "great_grandparent_3" ));
$c4 = esc_attr(get_field( "great_grandparent_4" ));
$c5 = esc_attr(get_field( "great_grandparent_5" ));
$c6 = esc_attr(get_field( "great_grandparent_6" ));
$c7 = esc_attr(get_field( "great_grandparent_7" ));
$c8 = esc_attr(get_field( "great_grandparent_8" ));
