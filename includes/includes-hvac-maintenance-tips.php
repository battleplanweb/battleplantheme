...
if ( $type == "teaser" ) :
	return do_shortcode('
		 ...
		 <img src="/wp-content/themes/battleplantheme/common/hvac-generic/maintenance-tips-teaser.jpg" alt="Above view of equipment being worked on." class="alignright size-quarter-s" />
