...
function battleplan_setupFormEmail( $contact_form, &$abort, $submission ) { 
	...
	if ( $userCountry != "United States" && ( stripos($buildEmail, "Chicken Dinner House") === false && stripos($buildEmail, "Sweetie Pie") === false && stripos($buildEmail, "Cooks Country") === false) && ( stripos($buildEmail, "Greater Fort Myers Dog Club") !== false || $message == '' )) $spamIntercept .= ' Country;';
