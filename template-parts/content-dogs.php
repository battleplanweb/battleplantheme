...
$birthdate = date_format($birthdate,"F j, Y");
...
?>
	...
	<div class="entry-content">
		...
		if ($studFee !== "0" && $studFee !== "") : $studFee = number_format($studFee?? 0.0, 2, '.', ','); $dogInfo .= "<li><span class='label'>Stud Fee:</span> $'.$studFee.'</li>"; endif;
		$dogInfo .= '</ul>';
